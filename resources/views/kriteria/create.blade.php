...
<style>
    ...
    .form-control-modern:focus {
        background: rgba(255, 255, 255, 0.01); border-color: #00d4ff; 
        box-shadow: 0 0 15px rgba(0, 212, 255, 0.2); outline: none;
    }
    .form-control-modern::placeholder { color: var(--text-muted); opacity: 0.5; }
    ...
    .btn-gradient-primary {
        ...
        border: none; border-radius: 12px; font-weight: 700; padding: 12px 30px; transition: all 0.3s ease;
    }
    .btn-gradient-primary:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(0, 212, 255, 0.4); color: #000; }

    .btn-outline-modern {
        background: transparent; border: 1px solid var(--card-border); color: var(--text-muted);
        border-radius: 12px; padding: 12px 24px; transition: all 0.2s ease;
    }
...
<div class="page-wrapper p-4 p-lg-5 flex-grow-1">
    ...
    <div class="container z-index-1 position-relative" style="max-width: 850px;">
        ...
        <div class="d-flex align-items-center mb-5 animate-entrance" style="animation-delay: 0.1s;">
            <div class="bg-primary bg-opacity-10 p-3 rounded-4 me-4 border border-primary border-opacity-25 shadow-sm d-flex justify-content-center align-items-center" style="width: 70px; height: 70px;">
                <i class="bi bi-plus-circle-fill text-info" style="font-size: 2.3rem; text-shadow: 0 0 20px rgba(0, 212, 255, 0.8);"></i>
            </div>
            <div>
                <h1 class="fw-bolder mb-1" style="color: var(--text-main);">Tambah Kriteria</h1>
                <p class="mb-0 fs-6" style="color: var(--text-muted);">Masukkan indikator penilaian baru untuk komputasi algoritma TOPSIS.</p>
            </div>
        </div>
            ...
            <form action="{{ route('kriteria.store') }}" method="POST">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="kode_kriteria" class="form-control form-control-modern fw-bold text-info" value="{{ old('kode_kriteria') }}" placeholder="Contoh: C1" required autocomplete="off">
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-bold small text-uppercase tracking-wider" style="color: var(--text-muted);">Nama Kriteria</label>
                        <input type="text" name="nama_kriteria" class="form-control form-control-modern" value="{{ old('nama_kriteria') }}" placeholder="Contoh: Market Sentiment, Tingkat Likuiditas" required autocomplete="off">
                    </div>
                </div>

                <div class="mb-4">
                    <label class="form-label fw-bold small text-uppercase tracking-wider" style="color: var(--text-muted);">Bobot Kriteria (W)</label>
                    <input type="number" step="any" name="bobot" class="form-control form-control-modern font-mono" value="{{ old('bobot') }}" placeholder="Masukkan angka persentase nilai bobot (Contoh: 25)" required autocomplete="off">
                    <div class="form-text opacity-50 mt-1" style="color: var(--text-muted); font-size: 0.8rem;">*Pastikan total nilai akumulasi bobot (C1 s/d C5) yang diinput bernilai murni 100%.</div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <input type="radio" name="jenis" id="type_benefit" value="benefit" class="radio-input" {{ old('jenis') == 'benefit' ? 'checked' : 'checked' }}>
                        ...
                        <div class="col-6">
                            <input type="radio" name="jenis" id="type_cost" value="cost" class="radio-input" {{ old('jenis') == 'cost' ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end gap-3 pt-3 border-top border-secondary border-opacity-10">
                    ...
                    <button type="submit" class="btn btn-gradient-primary">
                        <i class="bi bi-check-circle-fill me-1"></i> Simpan Kriteria
                    </button>
                </div>
